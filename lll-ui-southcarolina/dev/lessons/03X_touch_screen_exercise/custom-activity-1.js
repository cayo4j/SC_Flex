...
//$('canvas').click(function(e){
   ...
   //first action
            if(step1 == true){
                  if(canvasX > 123 && canvasY > 88 && canvasX < 169 && canvasY < 101){
                      step1 = false;
                      step2 = true;
                      ...
                      if(step1 != false){swal({title: "Incorrect.", text: "Press the Power Button on the bottom of the Touch Screen frame."});};
